...
from nanochat.flash_attention import HAS_FA3, HAS_FA4, USE_FA4, USE_FA3
...
if USE_FA4:
    ...
    print0("WARNING: Flash Attention 3/4 not available, using PyTorch SDPA fallback. Training will be less efficient.")
...
token_bytes = get_token_bytes(device=device, tokenizer_dir=None)
