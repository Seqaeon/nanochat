...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --eet-use-override|--eet-override-prob-start|--eet-override-prob-end|--eet-reenter-final|--eet-compute-skip|--eet-target-active-frac|--eet-capacity-schedule|--eet-exit-fracs|--eet-capacity-alignment-lambda|--eet-router-task-grad)
            EXTRA_ARGS+=("$1" "$2")
            shift 2
            ;;
        *)
