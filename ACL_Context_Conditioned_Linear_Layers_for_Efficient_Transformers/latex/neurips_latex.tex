...
This throughput gap is analogous to standard MoE: Mixtral-8$\times$7B has 47B total parameters but 13B active, yet is substantially slower than a 13B dense model in practice. Future work on fused Triton kernels that eliminate intermediate template assembly and reduce kernel launch overhead could narrow this gap; preliminary analysis suggests a 1.5--2$\times$ throughput improvement is achievable through kernel fusion alone.
