"""Public competition tier and dataset choices used by the CLI."""
...
TIERS: tuple[ComputeTier, ...] = (
    ...
    ComputeTier(
        ...
        daily_attempts=1,
        datasets=(
            DatasetOption("h1", "H1 · Hidden evaluation", None),
        ),
    ),
)
...
def resolve_tier_dataset(
    tier_id: str, dataset_id: str | None
) -> tuple[ComputeTier, DatasetOption]:
